            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('createCitizen') }}">
                        ...
                        <div class="form-group row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Lga') }}</label>

                            <div class="col-md-6">
                                <select id="lga_id" name="lga_id" required class="form-control">
                                    <option></option>
                                </select>
                        ...
                        <div class="form-group row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Ward') }}</label>

                            <div class="col-md-6">
                                <select id="ward_id" name="ward_id" required class="form-control">
                                    <option></option>
                                </select>
